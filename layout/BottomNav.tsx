  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-slate-950/90 backdrop-blur-xl border-t border-slate-800 z-50 flex justify-around p-2 pb-safe">
       ...
       <div className="relative -top-6">
         <Tooltip content="Adicionar novo registo" position="top">
            <button onClick={onNewLoan} className="w-14 h-14 bg-blue-600 rounded-full flex items-center justify-center text-white shadow-xl shadow-blue-600/40 active:scale-95 transition-all">
                <Plus size={24}/>
            </button>
         </Tooltip>
       </div>
