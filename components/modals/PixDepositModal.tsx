      ...
      <div className="space-y-4">
        {isPaid && (
          <div className="flex flex-col items-center justify-center py-10 space-y-4 animate-in zoom-in">
            ...
            <button
              onClick={onClose}
              className="w-full py-4 bg-emerald-600 hover:bg-emerald-500 text-white font-black rounded-xl uppercase transition-all shadow-lg mt-4"
            >
              Concluir
            </button>
          </div>
        ...
        {result && !isPaid && (
          <>
            <div className="bg-blue-900/20 border border-blue-500/30 p-3 rounded-xl flex items-center justify-between">
              <div>
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                readOnly
                className="w-full bg-slate-950 p-3 rounded-xl text-white text-[10px] font-mono outline-none border border-slate-800 focus:border-blue-500/50 transition-colors"
                rows={4}
              />
              ...
              <div className="flex flex-col gap-2 pt-2">
                <button
                  ...
                  className="w-full py-3 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-xl uppercase transition-all border border-slate-800 text-xs"
                >
