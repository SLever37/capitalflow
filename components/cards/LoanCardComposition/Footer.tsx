            ...
            <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-2 mb-3">
                ...
                {isFullyFinalized && (
                  <button
                    ...
                    className="col-span-2 sm:col-span-1 px-4 py-3 bg-emerald-950/30 text-emerald-400 border border-emerald-500/20 rounded-xl hover:bg-emerald-600 hover:text-white transition-all flex flex-col sm:flex-row items-center justify-center gap-2"
                  >
                    <RotateCcw size={14} /> 
                ...
                {!loan.isArchived && !isFullyFinalized && !hasActiveAgreement && onNewAporte && (
                  <button
                    ...
                    className="col-span-1 px-4 py-3 bg-blue-950/30 text-blue-400 border border-blue-500/20 rounded-xl hover:bg-blue-600 hover:text-white transition-all flex flex-col sm:flex-row items-center justify-center gap-2"
                  >
                    <Upload size={14} /> 
                ...
                {!loan.isArchived && !isFullyFinalized && !hasActiveAgreement && isLate && (
                   <button 
                    ...
                    className="col-span-2 sm:col-span-1 px-4 py-3 bg-indigo-950/30 text-indigo-400 border border-indigo-500/20 rounded-xl hover:bg-indigo-600 hover:text-white transition-all flex flex-col sm:flex-row items-center justify-center gap-2"
                   >
                      <Handshake size={14}/> 
