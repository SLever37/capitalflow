...
export const SourcesPage: React.FC<SourcesPageProps> = ({ 
  ...
  setIsAddFundsModalOpen, setAddFundsValue, openConfirmation, handleUpdateSourceBalance, isStealthMode
}) => {
  return (
    <div className="space-y-6">
        <div className="flex justify-between items-center"><h2 className="text-xl font-black uppercase tracking-tighter text-white">Fontes de Capital</h2><button onClick={() => setIsSourceModalOpen(true)} className="px-4 py-2 bg-blue-600 text-white rounded-xl text-[10px] font-black uppercase hover:bg-blue-500 transition-all shadow-lg shadow-blue-600/20 flex items-center gap-2"><Plus size={16}/> Nova Fonte</button></div>
