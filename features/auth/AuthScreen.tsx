    ...
    const handleActivate = async () => {
        ...
        try {
            ...
            const { error: profileError } = await supabase.from('perfis').insert({
                ...
                document: cleanDoc,
                phone: cleanPhone,
                access_level: 1, // Everyone is level 1 now
...
const LoginView = ({ loginUser, setLoginUser, loginPassword, setLoginPassword, showPassword, setShowPassword, submitLogin, isLoading, savedProfiles, handleSelectSavedProfile, handleRemoveSavedProfile, setIsCreatingProfile, setIsRecoveringPassword, handleDemoMode, handleGoogleLogin }: any) => (
    <div className="space-y-6">
        <div className="space-y-4 animate-in fade-in">
            ...
            <button onClick={handleGoogleLogin} disabled={isLoading} className="w-full py-4 bg-white hover:bg-slate-100 text-slate-900 rounded-2xl text-xs font-black uppercase shadow-lg flex items-center justify-center gap-3 transition-all active:scale-95">
                    ...
                    <>
                        ...
                        {isCreatingProfile && (
                            <div className="animate-in slide-in-from-right duration-300 space-y-4">
                                ...
                                <button onClick={handleGoogleLogin} className="w-full py-4 bg-white hover:bg-slate-100 text-slate-900 rounded-xl font-black uppercase text-xs flex items-center justify-center gap-3 transition-all active:scale-95">
